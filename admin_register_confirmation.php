                    ...
                    <div class="maxwidth450 paddingSides">
                        <div class="card sticky-action hoverable">
                            <div class="card-content">
                                <div class="ovalBorderRightGrey"><span class="green-text font18">Registration confirmed.</span>
                                    <br> Thank you. </div>
                                <div align="right"><img src="../../images/pharm/female/pharm-amanda-grey.svg" alt="Pharmacist Amanda" width="120" />
                                </div>
                                <p>&nbsp;</p>
                                <p class="font14 left-align">Thank you for confirming your registration with Red Apple Interactive Pharmacy.</p>
                                <div class="card-action center-align"> <a href="admin_login.php" class="waves-effect waves-light btn-flat grey-text">Please Login</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
