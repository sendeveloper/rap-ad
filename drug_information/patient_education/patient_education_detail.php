...
<a class="waves-effect waves-grey btn-flat green-text"><i class="material-icons left">edit</i>Update</a>
<a class="waves-effect waves-grey btn-flat red-text"><i class="material-icons left">list</i>List</a>
<a class="waves-effect waves-grey btn-flat red-text"><i class="material-icons left">delete</i>Delete</a>
