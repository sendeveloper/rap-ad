...
<div class="input-field">
          <input id="generic_name" type="text" class="validate">
...
<div class="input-field">
        <p>Need to configure editor to upload images to folder.</p>
         <p>Drug Class</p>
          <textarea id="drug_class" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug Used For</p>
          <textarea id="used_for" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug Dosage</p>
          <textarea id="drug_dosage" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>How To Take</p>
          <textarea id="how_to_take" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Side Effects</p>
          <textarea id="side_effects" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Precautions</p>
          <textarea id="precautions" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Contraindications</p>
          <textarea id="contraindications" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug Interactions</p>
          <textarea id="drug_interactions" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Pregnancy</p>
          <textarea id="pregnancy" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Breast Feeding</p>
          <textarea id="breast_feeding" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug Storage</p>
          <textarea id="drug_storage" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Overdose</p>
          <textarea id="overdose" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Missed Dose</p>
          <textarea id="missed_dose" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug FAQ</p>
          <textarea id="drug_faq" class="froalaTextarea"></textarea>
</div><br>

<div class="input-field">
         <p>Drug Video</p>
          <textarea id="drug_video" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Drug Resources</p>
          <textarea id="drug_resources" class="froalaTextarea"></textarea>
</div><br> 

<div class="input-field">
         <p>Pharmacist's Take</p>
          <textarea id="pharmacists_take" class="froalaTextarea"></textarea>
</div><br>
