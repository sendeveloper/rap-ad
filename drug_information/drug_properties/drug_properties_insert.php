            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6">
                        <h3 class="white-text center">Insert Drug</h3>
                        <p>&nbsp;</p>
                    </div>
                    <div class="col s12 m3">
                        <p>&nbsp;</p>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row center">
                    ...
                    <div class="col s12 m6">
                        <form id="drug_property_insert_form" method="POST">
                            <div class="input-field">
                                <input id="ndc" name="ndc" type="text" class="validate">
                                <label for="ndc" data-error="wrong" data-success="right">Drug NDC</label>
                            </div>
                            <div class="input-field">
                                <input id="brand_name" name="brand_name" type="text" class="validate">
                                <label for="brand_name" data-error="wrong" data-success="right">Drug Brand Name</label>
                            </div>
                            ...
                            <div class="input-field">
                                <input id="dosage_form" name="dosage_form" type="text" class="validate">
                                <label for="dosage_form" data-error="wrong" data-success="right">Drug Dosage Form</label>
                            </div>

                            <div class="input-field">
                                <input id="route_of_admin" name="route_of_admin" type="text" class="validate">
                                <label for="route_of_admin" data-error="wrong" data-success="right">Drug Route of Administration</label>
                            </div>

                            <div class="input-field">
                                <input id="manufacturer" name="manufacturer" type="text" class="validate">
                                <label for="manufacturer" data-error="wrong" data-success="right">Drug Manufacturer</label>
                            </div>

                            <div class="input-field">
                                <input id="strength" name="strength" type="text" class="validate">
                                <label for="strength" data-error="wrong" data-success="right">Drug Strength</label>
                            </div>
                            <p>&nbsp;</p>
                            ...
                            <ul>
                                <li>1. On Submit, insert form data into drug_properties table</li>
                                <li>2. After insert Go to drug_properties_list, ORDER Descending</li>
                            </ul>
