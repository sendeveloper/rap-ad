...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6">
                        <h4 class="white-text center">List of drug shapes</h4>
                        <p>&nbsp;</p>
                    </div>
                    <div class="col s12 m3">
                        <p>&nbsp;</p>
            ...
            <div class="container">
                ...
                <div class="row center">
                    ...
                    <div class="col s12 m8">
                        ...
                        <table class="highlight responsive-table bordered centered drug_shape_list">
                            <thead>
                                <tr>
                                    <th>Drug Shape</th>
                                    <th>Drug Image</th>
    ...
    <div id="deleteShapeModal" class="modal">
      <div class="modal-content">
          <h4 style="color: red;">Do you really want to delete this drug shape?</h4>
          <p>Drug shape: <b id="dlg_drug_shape"></b></p>
          <p>Drug image: <br/>
    ...
    <script>
      $(document).ready(function() {
        ...
        {
          var obj = $('.drug_shape_list tbody');
          var html = "";
          for (var i=0;i<data.length;i++)
          {
            var img = '<img src="' + data[i]['drug_shape_image_file'] + '" style="height: 40px;"/>';
            html += '<tr attr-id="' + data[i]['drug_shape_id'] + '"> \
                <td>' + data[i]['drug_shape'] + '</td> \
                <td>' + img + '</td> \
                <td> \
                    <p> \
