      ...
      <div class="section">   
        <div class="container">    
          ...
          <div class="row center">    
            ...
            <div class="col s12 m6 center z-depth-5">	 
              <h4 class="lime-text">Forgot Password?
              </h4>         
              <div class="row center">
                ...
                <div class="col s9">	 
                  <form id="forgot_pass_form" method="POST">        
                    ...
                    <br>            
                    <div>         
                      <button class="btn-flat waves-effect waves-light lime white-text" type="submit" name="action">Here you go
                        <i class="material-icons right">send
                        </i>  
                      </button>
                      <br>
                      <br>  
                      <a href="admin_login.php" class="waves-effect waves-light btn-flat amber-text text-accent-3">I Just remembered
                      </a>         
                    </div>        
                  </form>    
                </div>    
